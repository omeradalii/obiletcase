...
public class StepImplementation {
    ...
    @Step({"Rastgele email üret <element> buraya yaz"})
    public void emailRandomm (String key ) {
        Random random = new Random();

        String email = "kullanici" + random.nextInt(100) + "@gmail.com";

        System.out.println("Rastgele E-posta: " + email);
        sendKeysElement(key,email);
